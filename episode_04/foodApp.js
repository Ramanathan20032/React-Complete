  ...
  return (
    <div className="body">
      ...
      <div className="res-container">
        ...
        <RestaurentCard resData={restaurantList[1]} />
        <RestaurentCard resData={restaurantList[2]} />
        <RestaurentCard resData={restaurantList[3]} />
        <RestaurentCard resData={restaurantList[4]} />
        <RestaurentCard resData={restaurantList[5]} />
        <RestaurentCard resData={restaurantList[6]} />
        <RestaurentCard resData={restaurantList[7]} />
        <RestaurentCard resData={restaurantList[8]} />
        <RestaurentCard resData={restaurantList[9]} />
        <RestaurentCard resData={restaurantList[10]} />
        <RestaurentCard resData={restaurantList[11]} />
        <RestaurentCard resData={restaurantList[12]} />
        <RestaurentCard resData={restaurantList[13]} />
      </div>
    </div>
  );
};
